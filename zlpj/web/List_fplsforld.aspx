<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="List_fplsforld.aspx.cs" Inherits="List_fplsforld" %>
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th style="width: 100px;">
                        <a href="List_fplsforld.aspx?parameter=<%=Request["parameter"] %>&o=zf">总分<span class="ui-icon ui-icon-carat-1-s ui-spinner"></span></a>
                    </th>
                    <th style="width: 100px;">
                        是否评价
                    </th>
                    <th style="width: 100px;">
                        <a href="List_fplsforld.aspx?parameter=<%=Request["parameter"] %>&o=pjr">评价人<span class="ui-icon ui-icon-carat-1-s ui-spinner"></span></a>
                    </th>
                </tr>
            </thead>
            <tbody>
                <asp:ListView runat="server" ID="Listfpdetail" OnPagePropertiesChanging="rptList_PagePropertiesChanging">
                    <ItemTemplate>
                        <tr onclick="location.href='Detail_chakanforld.aspx?parameter=<%# Eval("appid") %>&h=<%=Request["parameter"]%>'">
                            <td>
