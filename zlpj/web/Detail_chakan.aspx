<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Detail_chakan.aspx.cs" Inherits="Detail_chakan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class="qianhead">
       ...
       <div class="link">
            <a href="List_fpls.aspx?parameter=<%=Request["h"] %>">分配详情</a>
        </div>
         <div class="link on">
            <a href="#">提案详情</a>
        </div>
