...
public partial class print : System.Web.UI.Page
{
    ...
    protected void bind()
    {
        ...
        var result = from t in talist where t.tclx=="0"
                     join lb in lblist on t.yjztc equals lb.id into s2 from lb in s2.DefaultIfEmpty()
        ...
        var result2 = from t in talist where t.tclx == "1"
