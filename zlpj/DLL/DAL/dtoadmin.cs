...
namespace DLL.DAL
{
    ...
    public partial class dtoadmin
    {
        ...
        public int Add(DLL.Model.dtoadmin model)
        {
            ...
            strSql.Append("insert into dtoadmin(");
            strSql.Append("fid,aid)");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update dtoadmin set ");
        ...
        public bool Delete(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from dtoadmin ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
        ...
        public DLL.Model.dtoadmin GetModel(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,fid,aid from dtoadmin ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
            ...
            DLL.Model.dtoadmin model = new DLL.Model.dtoadmin();
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,fid,aid ");
            strSql.Append(" FROM dtoadmin ");
            if (strWhere.Trim() != "")
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) FROM dtoadmin ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from dtoadmin T ");
