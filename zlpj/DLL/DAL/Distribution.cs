...
namespace DLL.DAL
{
    ...
    public partial class Distribution
    {
        ...
        public int Add(DLL.Model.Distribution model)
        {
            ...
            strSql.Append("name,sendTime,flag,addname)");
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@addname", SqlDbType.VarChar,255)};
        ...
        public DLL.Model.Distribution GetModel(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,name,sendTime,flag,addname from Distribution ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
            ...
            DLL.Model.Distribution model = new DLL.Model.Distribution();
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (ds.Tables[0].Rows[0]["addname"] != null && ds.Tables[0].Rows[0]["addname"].ToString() != "")
                {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,name,sendTime,flag,addname ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,name,sendTime,flag,addname ");
            strSql.Append(" FROM Distribution ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
