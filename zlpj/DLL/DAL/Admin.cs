...
namespace DLL.DAL
{
    ...
    public partial class Admin
    {
        ...
        public int Add(DLL.Model.Admin model)
        {
            ...
            strSql.Append("name,loginname,password,role)");
            strSql.Append(" values (");
            strSql.Append("@name,@loginname,@password,@role)");
            strSql.Append(";select @@IDENTITY");
            SqlParameter[] parameters = {
					new SqlParameter("@name", SqlDbType.VarChar,255),
					new SqlParameter("@loginname", SqlDbType.VarChar,255),
        ...
        public DLL.Model.Admin GetModel(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,name,loginname,password,role from Admin ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,name,loginname,password,role ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,name,loginname,password,role ");
            strSql.Append(" FROM Admin ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
