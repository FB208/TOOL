...
namespace DLL.DAL
{
    ...
    public partial class sop
    {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("Id", "sop");
        }
        ...
        public bool Exists(int Id)
        {
            ...
            strSql.Append("select count(1) from sop");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into sop(");
            strSql.Append("defineId,brand,info,type)");
            strSql.Append(" values (");
            strSql.Append("@defineId,@brand,@info,@type)");
            SqlParameter[] parameters = {
					
					new SqlParameter("@defineId", SqlDbType.VarChar,255),
					new SqlParameter("@brand", SqlDbType.VarChar,255),
					new SqlParameter("@info", SqlDbType.VarChar,255),
        ...
        public DLL.Model.sop GetModel(int Id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 Id,defineId,brand,info,type from sop ");
            strSql.Append(" where Id=@Id ");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)			};
            parameters[0].Value = Id;

            DLL.Model.sop model = new DLL.Model.sop();
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select Id,defineId,brand,info,type ");
            strSql.Append(" FROM sop ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" Id,defineId,brand,info,type ");
            strSql.Append(" FROM sop ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from sop T ");
