<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="adddetail.aspx.cs" Inherits="adddetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="tip">添加设备</div>
    <table class="table nohover" border="1">
        <tr>
            <td style="width: 10%; text-align: center;">机器编号</td>
            <td style="width: 35%; text-align: center;">
                <asp:TextBox ID="TextBoxdefine" runat="server" Width="30%"></asp:TextBox></td>
        ...
        <tr>
            ...
            <td style="width: 35%; text-align: center;">
                <asp:DropDownList ID="DropDownListnet" runat="server" Width="30%"></asp:DropDownList>
            </td>
            <td style="width: 10%; text-align: center;">MAC地址</td>
            <td style="width: 35%; text-align: center;">
                <asp:TextBox ID="TextBoxMac" runat="server" Width="30%"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td style="width: 10%; text-align: center;">使用情况</td>
            <td style="width: 35%; text-align: center;">
                <asp:DropDownList ID="DropDownListflag" runat="server" Width="30.5%"></asp:DropDownList></td>
            <td style="width: 10%; text-align: center;">类型</td>
            <td style="width: 35%; text-align: center;">
                <asp:DropDownList ID="DropDownListtype" runat="server" Width="30.5%"></asp:DropDownList></td>
        </tr>
        <tr>
            <td style="width: 10%; text-align: center;">内网IP</td>
            <td style="width: 35%; text-align: center;">
                <asp:TextBox ID="TextBoxiIP" runat="server" Width="30%"></asp:TextBox></td>
            <td style="width: 10%; text-align: center;">外网IP</td>
            <td style="width: 35%; text-align: center;">
                <asp:TextBox ID="TextBoxoIP" runat="server" Width="30%"></asp:TextBox></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4" style="text-align: center;">
                <asp:TextBox ID="TextBoxsInfo" runat="server" Width="80%" CssClass="text-middle"></asp:TextBox></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4" style="text-align: center;">
                <asp:TextBox ID="TextBoxscInfo" runat="server" Width="80%" CssClass="text-middle"></asp:TextBox></td>
        </tr>
        ...
        <tr>
            <td colspan="4" style="text-align: center;">
                <asp:TextBox ID="TextBoxdescri" runat="server" Width="80%" CssClass="text-middle"></asp:TextBox></td>
        </tr>
    ...
    <div style="margin-top: 10px; text-align: center;">
        <asp:Button ID="ImageButtonsave" CssClass="u-btn u-btn-sm" runat="server" Text="添加" OnClick="ImageButtonsave_Click" />
    </div>
</asp:Content>
