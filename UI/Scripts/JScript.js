...
$(function () {
    ...
    $('.vtitle').click(function () {
        ...
        $('.vtitle').each(function (e) {
            if (e == tabs_i) {
                $(this).addClass('hid').children().removeClass("a-white");
            } else {
                $(this).removeClass('hid').children().addClass("a-white");
            }
        });
    ...
    if (document.cookie == "hid") {
        ...
        $('.hidbutton').addClass("f-img-right");
    }
    //文本框
    $("input[type=text],textarea").addClass("u-ipt");
    //////按钮渲染
...
function hiddenleft() {
    ...
    if ($('.g-hd').css("display") != "block") {
        ...
        $('.hidbutton').removeClass("f-img-right");
